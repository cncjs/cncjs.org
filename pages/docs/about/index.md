...
It took me about 3 months to build a three axis CNC machine from scratch, and another 1 month to create the first CNC web interface in React with 10+ languages. This project is in active development after the talk, and I received many useful feedbacks from people all around the world.
